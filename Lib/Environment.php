...
class Environment
{
     ...
     * @return bool
     **/
    public static function start($environment = null, $default = 'production')
    {
        $_this = Environment::getInstance();
     ...
     **/
    public function setup($environment = null, $default = 'production')
    {
     ...
     * @return string
     **/
    protected function currentEnvironment($environment = null, $default = 'production')
    {
